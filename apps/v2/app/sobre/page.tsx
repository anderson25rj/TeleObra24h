...
const values = [
  ...
  },
  {
    icon: Users,
    title: 'Comunidade',
    description: 'Construímos uma rede forte de profissionais e clientes satisfeitos na Região dos Lagos.',
...
const timeline = [
  ...
  },
  {
    ...
    description: 'Expandimos para todas as 7 cidades da Região dos Lagos, alcançando mais de 1.000 profissionais.'
  },
  {
    year: '2025',
    ...
    <main className="min-h-screen bg-white">
      ...
      <section ref={heroRef} className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          >
            Transformando a Região dos Lagos
          </motion.h1>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              ...
              da Região dos Lagos, transformando vidas e negócios.
            </p>
          </motion.div>
